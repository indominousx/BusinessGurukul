...
export default function Internship() {
  return (
    <div className="bg-purple-50 min-h-screen w-full">
      ...
      <div className="w-screen relative left-1/2 right-1/2 -translate-x-1/2 bg-gradient-to-r from-green-600 to-blue-600 py-16 flex items-center justify-center" style={{minHeight: '350px'}}>
