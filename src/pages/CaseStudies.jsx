        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between max-w-6xl">
          <div>
            ...
            <div className="mt-6">
              <Link to="/contact" 
              style={{ color: 'white' }}
              className="inline-block bg-black hover:bg-gray-600 text-white visited:text-white focus:text-gray-200 active:text-gray-200 hover:text-gray-200 font-bold px-6 py-3 rounded-lg shadow transition text-lg">
                Contact Us
              </Link>
            </div>
          </div>
