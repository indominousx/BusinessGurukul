      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center py-16">
        ...
        <div className="md:w-2/3 p-10 flex flex-col justify-center">
          ...
          <p className="text-gray-700 mb-4">
            Embracing digitization is just halfway to business success. It is
            also imperative to extend your online marketplace reach. Thus, reap
            the benefits of ROI-driven digital marketing solutions. As a
            ...
            lucrative online marketing ideas generated by our digital marketing
            experts. And experience your business growth ahead.
          </p>
        </div>
